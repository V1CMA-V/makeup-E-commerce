...
export default function Information({ product }: InformationProps) {
  ...
  return (
    <section
      className="grid gap-14 px-10 pt-10 pb-24"
    ...
    >
      ...
      <div className="sticky top-8 self-start">
        <div className="font-mono text-[11px] tracking-[0.28em] uppercase text-[#1d1812]/60 mb-[14px]">
          {product.cat} · Edición permanente · Ref. {product.ref}
        </div>
        <h1 className="font-title text-[56px] m-0 leading-[1.05] font-normal">
          {first} <em className="font-heading font-light">{rest.join(' ')}</em>
        </h1>
        <p className="font-heading text-lg italic text-[#1d1812]/60 mt-[18px] mb-7 leading-[1.45]">
          Un rouge mate de comodidad inmediata. Pigmento profundo, acabado de seda
          envejecida. Pensado para reaplicarse sin pensar.
        </p>

        <div className="flex items-baseline gap-[14px] pb-[22px] border-b border-[#1d1812]/15">
          <div className="font-title text-4xl">{product.price}</div>
          ...
          <div className="font-heading text-sm italic text-[#1d1812]/60">
            ★★★★★ <span className="not-italic">· 218 opiniones</span>
          </div>
        </div>
        ...
        >
          ...
          <button
            type="button"
            className="font-sans bg-[#1d1812] text-[#f6f1e5] py-[14px] text-[11px] tracking-[0.32em] uppercase"
          >
        ...
        <div className="mt-4 flex gap-6">
          <button
            type="button"
            className="font-heading text-sm italic border-b border-[#1d1812]/60"
          >
